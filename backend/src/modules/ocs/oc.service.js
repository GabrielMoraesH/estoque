...
const EXPORT_STATUS_LABELS = { em_contagem: 'Em contagem', aguardando_aprovacao: 'Aguardando aprovação', em_recontagem: 'Em recontagem', finalizada: 'Finalizada' };
...
function createOcService({ repository, audit = noopAudit, csvSerializer = serializeCsv } = {}) {
